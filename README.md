...
| Project | Description |
| --- | --- |
| `TileViewer.ManagedPlugin` | Class library targeting `net9.0` with AOT publishing enabled. |
...
3. Reference `TileViewer.ManagedPlugin` from a TileViewer host application and instantiate `ManagedTileViewerPlugin` to access the managed API.
